...
namespace WinTagger.db1DataSetTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private Giata_hotelTableAdapter _giata_hotelTableAdapter;
    ...
    public Giata_hotelTableAdapter Giata_hotelTableAdapter
    {
      get => this._giata_hotelTableAdapter;
      set => this._giata_hotelTableAdapter = value;
    }
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._giata_hotelTableAdapter != null && this._giata_hotelTableAdapter.Connection != null ? (IDbConnection) this._giata_hotelTableAdapter.Connection : (IDbConnection) null;
      }
    ...
    public int TableAdapterInstanceCount
    {
      get
      {
        ...
        if (this._giata_hotelTableAdapter != null)
      ...
      List<DataRow> allAddedRows)
    {
      ...
      if (this._giata_hotelTableAdapter != null)
      {
        DataRow[] realUpdatedRows = this.GetRealUpdatedRows(dataSet.Giata_hotel.Select((string) null, (string) null, DataViewRowState.ModifiedCurrent), allAddedRows);
        if (realUpdatedRows != null && realUpdatedRows.Length != 0)
        {
          num += this._giata_hotelTableAdapter.Update(realUpdatedRows);
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    private int UpdateInsertedRows(db1DataSet dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._giata_hotelTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Giata_hotel.Select((string) null, (string) null, DataViewRowState.Added);
        if (dataRowArray != null && dataRowArray.Length != 0)
        {
          num += this._giata_hotelTableAdapter.Update(dataRowArray);
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    private int UpdateDeletedRows(db1DataSet dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._giata_hotelTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Giata_hotel.Select((string) null, (string) null, DataViewRowState.Deleted);
        if (dataRowArray != null && dataRowArray.Length != 0)
        {
          num += this._giata_hotelTableAdapter.Update(dataRowArray);
    ...
    public virtual int UpdateAll(db1DataSet dataSet)
    {
      ...
      if (!dataSet.HasChanges())
        return 0;
      if (this._giata_hotelTableAdapter != null && !this.MatchTableAdapterConnection((IDbConnection) this._giata_hotelTableAdapter.Connection))
      ...
      try
      {
        if (this._giata_hotelTableAdapter != null)
        {
          dictionary.Add((object) this._giata_hotelTableAdapter, (IDbConnection) this._giata_hotelTableAdapter.Connection);
          this._giata_hotelTableAdapter.Connection = (OleDbConnection) connection;
          this._giata_hotelTableAdapter.Transaction = (OleDbTransaction) dbTransaction;
          if (this._giata_hotelTableAdapter.Adapter.AcceptChangesDuringUpdate)
          {
            this._giata_hotelTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
            dataAdapterList.Add((DataAdapter) this._giata_hotelTableAdapter.Adapter);
          }
        }
      ...
      finally
      {
        ...
        if (this._giata_hotelTableAdapter != null)
        {
          this._giata_hotelTableAdapter.Connection = (OleDbConnection) dictionary[(object) this._giata_hotelTableAdapter];
          this._giata_hotelTableAdapter.Transaction = (OleDbTransaction) null;
        }
